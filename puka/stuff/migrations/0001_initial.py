    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_transactions', to='stuff.location')),
                ('to_location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='to_transactions', to='stuff.location')),
            ],
            options={
