...
npm-update:
    npm install tailwindcss@latest @tailwindcss/cli@latest @tailwindcss/forms@latest daisyui@latest htmx.org@4.0.0-beta2 alpinejs@latest @alpinejs/focus@latest esbuild@latest
