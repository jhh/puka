defmodule PukaWeb.Router do
  use PukaWeb, :router

  import PukaWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {PukaWeb.Layouts, :root}
  ...
  # scope "/api", PukaWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:puka, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PukaWeb.Telemetry
  ...
  scope "/", PukaWeb do
    ...
    live_session :current_user,
      on_mount: [{PukaWeb.UserAuth, :mount_current_scope}] do
